...
logic [4:0] FpgaPins_Fpga_CPU_imem_addr_a1;
...
logic [31:0] FpgaPins_Fpga_CPU_Dmem_value_a4 [31:0],
          FpgaPins_Fpga_CPU_Dmem_value_a5 [31:0];
...
//
   ...
   //
      ...
      //
         ...
         always_ff @(posedge clk) FpgaPins_Fpga_CPU_imem_addr_a1[4:0] <= FpgaPins_Fpga_CPU_imem_addr_a0[4:0];
         ...
         // Scope: /dmem[31:0]
         //
         for (dmem = 0; dmem <= 31; dmem++) begin : L1gen_FpgaPins_Fpga_CPU_Dmem
            // Staging of $value.
...
//_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 602 as: m5+tt_connections()
...
//_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 605 as: m5+board(/top, /fpga, 7, $, , cpu)
      ...
      //_/fpga
         //_\source top.tlv 54   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+cpu.
            ...
            //_|cpu
               ...
               //_@1
                  for (imem = 0; imem <= 31; imem++) begin : L1_FpgaPins_Fpga_CPU_Imem //_/imem
                     ...
                     assign L1_wr_a1 = FpgaPins_Fpga_CPU_imem_wr_en_a1 && (FpgaPins_Fpga_CPU_imem_addr_a1[4:0] == imem);
                  ...
                  //_?$imem_rd_en
                     assign FpgaPins_Fpga_CPU_imem_rd_data_a1[31:0] = FpgaPins_Fpga_CPU_Imem_value_a2[FpgaPins_Fpga_CPU_imem_addr_a1[4:0]];
            ...
            //_|cpu
               ...
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/riscvshelllib.tlv 50   // Instantiated from top.tlv, 292 as: m4+dmem(@4)
                  // Data Memory
                  //_@4
                     for (dmem = 0; dmem <= 31; dmem++) begin : L1_FpgaPins_Fpga_CPU_Dmem //_/dmem

                        // For $wr.
                        logic L1_wr_a4;

                        assign L1_wr_a4 = FpgaPins_Fpga_CPU_dmem_wr_en_a4 && (FpgaPins_Fpga_CPU_dmem_addr_a4[4:0] == dmem);
                     ...
                     //_?$dmem_rd_en
                        assign FpgaPins_Fpga_CPU_dmem_rd_data_a4[31:0] = FpgaPins_Fpga_CPU_Dmem_value_a5[FpgaPins_Fpga_CPU_dmem_addr_a4[4:0]];
...
//_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 607 as: m5+tt_input_labels_viz(⌈"UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED"⌉)
